...
<form id="form" name="form" action="${basePath}nsfw/complain_deal.action" method="post" enctype="multipart/form-data">
    ...
    <div class="tableH2">投诉详细信息<span style="color:red;">(<s:property value="#complainState[complain.compState]"/>)</span></div>
    <table id="baseInfo" width="100%" align="center" class="list" border="0" cellpadding="0" cellspacing="0"  >
    	<tr><td colspan="2" align="center">投诉人信息</td></tr>
        <tr>
            <td class="tdBg" width="250px">是否匿名投诉：</td>
            <td><s:property value="%{complain.isAnon?'匿名投诉':'非匿名投诉'}"/></td>
        </tr>
        <tr>
            <td class="tdBg">投诉人单位：</td>
            <td>
                <s:if test="!complain.isAnon">
                    <s:property value="complain.compComp"/>
                </s:if>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <s:elseif test="%{complain.compMobile > 10}">
        ...
        <tr>
            ...
            <td><s:date name="complain.comTime" format="yyyy-MM-dd HH:mm"/></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><s:property value="complain.compContent" escapeHtml="false"/></td>
        </tr>
        <s:if test="isSee == null">
            ...
            <tr>
                ...
                <s:hidden name="complainReply.replyDept" value="%{#session.SYS_USER.dept}"/>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <s:hidden name="complainReply.replyName" value="%{#session.SYS_USER.name}"/>
                </td>
            </tr>
            <tr>
