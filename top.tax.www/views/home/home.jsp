            ...
            <table width="98%" border="0" align="center">
            	<s:iterator value="infoList">
                    <tr>
                        ...
                        <td width="150px"><s:property value="#INFO_TYPE[type]"/></td>
                        <td width="150px"><s:property value="creator"/></td>
                        <td width="150px"><s:date name="createTime" format="yy-MM-dd HH:mm"/></td>
                    </tr>
                </s:iterator>
            </table>
            <div style="float: right;padding-right: 66px"><a href="#">更多>></a></div>
        </div>
    </div>
    <!-- }右-->
    <div class="clear"></div>
        ...
        <div class="lc_grzx1">
            ...
            <table width="98%" border="0" align="center">
                <s:iterator value="complainList">
                    <tr>
                        <td height="23">
                            <s:url var="complainViewUI" namespace="/sys" action="home_complainViewUI">
                        ...
                        <td width="180px"><s:property value="#complainState[compState]"/></td>
                        <td width="180px"><s:property value="%{isAnon==1?'匿名投诉':'非匿名投诉'}"/></td>
                        <td width="180px"><s:date name="comTime" format="yy-MM-dd HH:mm"/></td>
                    </tr>
                </s:iterator>
            </table>
            <div style="float: right;padding-right: 105px"><a href="#">更多>></a></div>
        </div>
